...
urlpatterns = [
    ...
    # Chat rooms
    path("api/v1/ai/",           include("apps.ai_assistant.api.v1.urls")),
    path("api/v1/live/",          include("apps.livesessions.api.v1.urls")),
    path("api/v1/flashcards/",  include("apps.flashcards.api.v1.urls")),
